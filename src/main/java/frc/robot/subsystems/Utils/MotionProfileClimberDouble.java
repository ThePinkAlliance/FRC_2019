...
public class MotionProfileClimberDouble {
	 ...
	 * Called every loop.
	 */
	public void control(ClimberDirection direction, PodPosition location, ClimbLevel level) {
		...
		if (_talon.getControlMode() != ControlMode.MotionProfile) {
			...
			case 0: /* wait for application to tell us to start an MP */
				if (_bStart) {
					...
					_setValue = SetValueMotionProfile.Disable;
					startFilling(direction, location, level);
					/*
	...
	private void startFilling(ClimberDirection direction, PodPosition location, ClimbLevel level) {
