...
public class Elevator extends Subsystem {
  ...
  public Elevator() {
    ...
    _elevator.setSmartCurrentLimit(currentLimit);
  
    _elevatorTopSwitch = new DigitalInput(5);
    _elevatorBottonSwitch = new DigitalInput(4);
    // initMotor();
  }
  ...
  public void setEncoderPosition(int position) {
    _elevator.setEncPosition(position);
  }
