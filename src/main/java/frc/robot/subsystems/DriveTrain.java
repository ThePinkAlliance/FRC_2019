...
// Subsystem for setting up drive train for use in commands
public class DriveTrain extends Subsystem {
  ...
  public boolean drive_to_position(double target_distance, double target_angle) {
    ...
    if (turn_to_angle(target_angle)) {
      drive_to_distance(target_distance);
    } else {
      turn_to_angle(target_angle);
    }

    return drive_to_distance(target_distance) && turn_to_angle(target_angle);
  }
