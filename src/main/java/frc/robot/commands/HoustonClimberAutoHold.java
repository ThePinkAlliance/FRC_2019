...
public class HoustonClimberAutoHold extends Command {
  ...
  public HoustonClimberAutoHold(double power1, double power2, double phase1Time, double watchDogTime) {
  ...
  protected void end() {
    climberPod.set(0);
    ball._collectorRotateMotor.set(ControlMode.PercentOutput, 0);
  }
