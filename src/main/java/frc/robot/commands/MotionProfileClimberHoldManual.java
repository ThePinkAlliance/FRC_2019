...
public class MotionProfileClimberHoldManual extends Command {
  ...
  public MotionProfileClimberHoldManual(MotionProfileClimber theClimberPod, double power1, double power2, double phase1Time, double watchDogTime) {
